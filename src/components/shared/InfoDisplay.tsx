...
export default function InfoDisplay({
  ...
  const backgroundImage = basePath.includes('products')
    ? "url('/images/products_bg.jpg')"
    : "url('/images/services_bg.png')"
  ...
  return (
    <div className="w-full flex flex-col min-h-160 md:flex-row bg-white">
      ...
      {/* Columna derecha */}
      <div className="relative w-full md:w-8/12 flex flex-col items-center justify-start p-8 gap-10 overflow-hidden">
        {/* Fondo con imagen */}
        <div
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-start gap-10">
          {/* Botón volver */}
